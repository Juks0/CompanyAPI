...
public class DatabaseContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        //     new Customer
        //     {
        //         CustomerId = 1,CustomerType = "Individual", Address = "123 Main St, Warsaw, Poland", Email = "john.doe@example.com",
        //         PhoneNumber = "+48123456789"
        //     },
        //     new Customer
        //     {
        //         CustomerId = 2,CustomerType = "Individual", Address = "456 Elm St, Krakow, Poland", Email = "jane.smith@example.com",
        //         PhoneNumber = "+48234567890"
        //     },
        //     new Customer
        //     {
        //         CustomerId = 3,CustomerType = "Individual", Address = "789 Oak St, Poznan, Poland", Email = "mike.johnson@example.com",
        //         PhoneNumber = "+48345678901"
        //     },
        //     new Customer
        //     {
        //         CustomerId = 4,CustomerType = "Individual", Address = "101 Pine St, Wroclaw, Poland", Email = "lisa.brown@example.com",
        //         PhoneNumber = "+48456789012"
        //     },
        //     new Customer
        //     {
        //         CustomerId = 5,CustomerType = "Individual", Address = "202 Cedar St, Gdansk, Poland", Email = "paul.davis@example.com",
        //         PhoneNumber = "+48567890123"
        //     },
        //     new Customer
        //     {
        //         CustomerId = 6,CustomerType = "Company", Address = "303 Birch St, Warsaw, Poland", Email = "info@company1.com",
        //         PhoneNumber = "+48678901234"
        //     },
        //     new Customer
        //     {
        //         CustomerId = 7,CustomerType = "Company", Address = "404 Maple St, Krakow, Poland", Email = "contact@company2.com",
        //         PhoneNumber = "+48789012345"
        //     },
        //     new Customer
        //     {
        //         CustomerId = 8,CustomerType = "Company", Address = "505 Redwood St, Poznan, Poland", Email = "support@company3.com",
        ...
        modelBuilder.Entity<IndividualCustomer>().HasData(new List<IndividualCustomer>()
        {
            ...
            {
                CustomerId = 1, CustomerType = "Company", Address = "707 Willow St, Gdansk, Poland",
                Email = "info@company5.com",
                PhoneNumber = "+48101234568", FirstName = "John", LastName = "Doe", PESEL = "12345678901"
            },
            new IndividualCustomer
            {
                CustomerId = 2, CustomerType = "Individual", Address = "808 Maple St, Warsaw, Poland",
                Email = "jane.smith@example.com", PhoneNumber = "+48234567890", FirstName = "Jane", LastName = "Smith",
                PESEL = "23456789012"
            },
            new IndividualCustomer
            {
                CustomerId = 3, CustomerType = "Individual", Address = "909 Oak St, Krakow, Poland",
                Email = "alice.johnson@example.com", PhoneNumber = "+48345678901", FirstName = "Alice", LastName = "Johnson",
                PESEL = "34567890123"
            },
            new IndividualCustomer
            {
                CustomerId = 4, CustomerType = "Individual", Address = "1010 Pine St, Wroclaw, Poland",
                Email = "bob.brown@example.com", PhoneNumber = "+48456789012", FirstName = "Bob", LastName = "Brown",
                PESEL = "45678901234"
            },
            new IndividualCustomer
            {
                CustomerId = 5, CustomerType = "Individual", Address = "1111 Cedar St, Poznan, Poland",
        ...
        modelBuilder.Entity<CompanyCustomer>().HasData(new List<CompanyCustomer>()
        {
            new CompanyCustomer
            {
                CustomerId = 6, CustomerType = "Company", CompanyName = "Company 1", Address = "123 Birch St, Warsaw, Poland",
                Email = "info@company1.com", PhoneNumber = "+48678901234", KRS = "1234567890"
            },
            new CompanyCustomer
            {
                CustomerId = 7, CustomerType = "Company", CompanyName = "Company 2", Address = "234 Pine St, Krakow, Poland",
                Email = "info@company2.com", PhoneNumber = "+48789012345", KRS = "2345678901"
            },
            new CompanyCustomer
            {
                CustomerId = 8, CustomerType = "Company", CompanyName = "Company 3", Address = "345 Oak St, Poznan, Poland",
                Email = "info@company3.com", PhoneNumber = "+48890123456", KRS = "3456789012"
            },
            new CompanyCustomer
            {
                CustomerId = 9, CustomerType = "Company", CompanyName = "Company 4", Address = "456 Maple St, Wroclaw, Poland",
                Email = "info@company4.com", PhoneNumber = "+48901234567", KRS = "4567890123"
            },
            new CompanyCustomer
            {
                CustomerId = 10, CustomerType = "Company", CompanyName = "Company 5", Address = "567 Willow St, Gdansk, Poland",
        ...
        modelBuilder.Entity<Software>().HasData(new List<Software>()
        {
            new Software
            {
               SoftwareId = 1,Name = "Finance Pro", Description = "Financial management software", CurrentVersion = "1.0",
                Category = "Finance"
            },
            new Software
            {
                SoftwareId = 2, Name = "Edu Learn", Description = "Educational software for schools", CurrentVersion = "2.1",
                Category = "Education"
            },
            new Software
            {
                SoftwareId = 3,Name = "Health Tracker", Description = "Health monitoring software", CurrentVersion = "3.3",
                Category = "Health"
            },
            new Software
            {
                SoftwareId = 4, Name = "Retail Manager", Description = "Retail management software", CurrentVersion = "4.5",
                Category = "Retail"
            },
            new Software
            {
                SoftwareId = 5, Name = "Real Estate Pro", Description = "Real estate management software", CurrentVersion = "1.2",
                Category = "Real Estate"
            },
            new Software
            {
                SoftwareId = 6, Name = "Marketing Hub", Description = "Marketing automation software", CurrentVersion = "5.0",
                Category = "Marketing"
            },
            new Software
            {
                SoftwareId = 7, Name = "Project Planner", Description = "Project management software", CurrentVersion = "2.4",
                Category = "Productivity"
            },
            new Software
            {
                SoftwareId = 8, Name = "CRM Boost", Description = "Customer relationship management software", CurrentVersion = "3.6",
                Category = "CRM"
            },
            new Software
            {
                SoftwareId = 9, Name = "HR Connect", Description = "Human resources management software", CurrentVersion = "4.0",
                Category = "HR"
            },
            new Software
            {
                SoftwareId = 10, Name = "Logistics Pro", Description = "Logistics and supply chain software", CurrentVersion = "1.5",
                Category = "Logistics"
            }
        });
